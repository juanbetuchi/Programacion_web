...
// solo ejecuta si estamos en la pagina del catalogo
if (contenedor_filtrado) cargarProductos();
...
function renderizarDetalle(producto) {
  ...
  stock.className   = 'detalle-stock';
  stock.textContent = producto.estaDisponible ? `Stock: ${producto.stock}` : 'Sin stock';
...
if (contenedor_producto) cargarProducto();
